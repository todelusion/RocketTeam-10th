<template>
  <ul class="mx-auto lg:bg-primary lg:px-4 lg:pb-4">
    ...
    <li class="mb-2 flex justify-between font-light text-primary lg:text-second">
      <p>小計</p>
      <p>NT$ 2,700</p>
    </li>
    <li class="mb-2 flex justify-between font-light text-primary lg:text-second">
    ...
    <li class="flex justify-between text-xl font-semibold text-primary lg:text-white">
      <p>總計</p>
      <p>NT$ 3,000</p>
    </li>
  </ul>
